...
const skillList = [
  {
    ...
    desc:
      "Worked on Grid and Flexbox, on top of all the latest ES features of JavaScript",
  },
  {
    id: 2,
    title: "Designing",
  ...
  },
  {
    ...
    desc:
      "I have a Post-Graduate Diploma in Project Management, with extensive knowledge of Tools and Techniques.",
  },
  {
    id: 5,
    title: "Tools & OS",
    ...
    <div className='container d-flex flex-column mt-5 vh-100'>
      <div className='row justify-content-center'>
        {skillList.map((item) => {
          ...
          return (
            <div
              className='card text-center shadow mx-2 my-2'
              style={{ width: "22rem", height: "16rem" }}
              key={id}
            >
              <p
                className='card-title container text-light p-2'
